    ...
    <div className="py-16 px-4 bg-gray-800">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-white/80 text-lg">Find us at any of our convenient locations</p>
        </div>

        <div className="bg-white rounded-2xl border border-border shadow-2xl overflow-hidden min-h-[420px]">
